            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>+57 3017948578</a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i>guerrero06@gmail.com</a> </li>
                     </ul>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-12 col-lg-7">
               <div class="about_box">
                  ...
                  <h3>SOLUCIONES DE TRABAJO EN TODAS LAS TECNOLOGIAS</h3>
                  <span>PC, Portatiles, Impresoras, Celulares, Camaras, Redes y Todo Ecosistema Digital TIC <br> Trabajo Eficiente y con gran experiencia en el servicio y atencion al cliente</span>
   ...
   <div id="contact" class="contact ">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <div class="titlepage">
                  <h2><strong class="yellow">SOLICITAR CONTACTENOS</strong><br>DEVOLUCIÓN DE LLAMADA</h2>
               </div>
            </div>
         </div>
         <div class="row">
            <div class="col-md-8 offset-md-2">
               <form id="post_form" class="contact_form" method="post">
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <input class="contact_control" placeholder="Phone Number " type="type" name="Phone">
                     </div>
                     <div class="col-md-12">
